...
<script>const API_BASE_URL = <?php echo json_encode(rtrim(getenv('MAPPER_API_URL') ?: 'http://127.0.0.1:5000', '/'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;</script>
</head>
<body>
        ...
        $(document).ready(function() {
			...
			$('#uploadForm').on('submit', function(e) {
				...
				const progresoIntervalo = setInterval(function() {
					$.getJSON((API_BASE_URL + "/progreso"), function(data) {
